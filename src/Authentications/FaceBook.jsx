...
//   }, [auth.isAuthenticated, navigate]);
  ...
  const handleLoginSuccess = (response) => {
    ...
    console.log("Picture URL:", profileData.picture?.data?.url || "No picture available");
      ...
      <div className="bg-white rounded-2xl shadow-xl p-12 max-w-md w-full transform transition-all duration-300 hover:shadow-2xl">
        <div className="space-y-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-800 mb-3 animate-bounce">Welcome Back</h1>
            <p className="text-gray-600 text-lg">Connect with Facebook & Google</p>
          </div>
